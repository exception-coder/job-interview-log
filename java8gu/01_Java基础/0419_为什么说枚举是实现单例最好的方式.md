...
如果你看过《[单例模式的多种写法](https://www.yuque.com/hollis666/fsn3og/ggh2h0)》中的实现单例的所有方式的代码，那就会发现，各种方式实现单例的代码都比较复杂。主要原因是在考虑线程安全问题。
...
> 📎 相关：[✅如何破坏单例模式？](https://www.yuque.com/hollis666/fsn3og/vqtp00#WKH7c)
