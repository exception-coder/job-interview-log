...
1. **基于 @AspectJ 注解的 AOP**

- 使用 `@Aspect` 注解定义切面。
- 配合 `@EnableAspectJAutoProxy` 开启自动代理。
-  功能更强大（支持字段、构造器、静态块等），通过编译期或类加载期织入。

> 📎 相关：[🔜SpringBean的初始化流程](https://www.yuque.com/hollis666/fsn3og/zlvhpz)
...
![image.png](https://cdn.nlark.com/yuque/0/2023/png/719664/1673766092954-e6308cd9-ce8d-4854-9b97-1c785721bff4.png?x-oss-process=image%2Fwatermark%2Ctype_d3F5LW1pY3JvaGVp%2Csize_21%2Ctext_SmF2YSA4IEd1IDAy%2Ccolor_FFFFFF%2Cshadow_50%2Ct_80%2Cg_se%2Cx_10%2Cy_10)
...
> 📎 相关：[🔜Spring在业务中常见的使用方式](https://www.yuque.com/hollis666/fsn3og/xn5f5v)
