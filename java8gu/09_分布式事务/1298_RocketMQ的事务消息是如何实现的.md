...
> 📎 相关：[✅什么是事务消息，为什么需要事务消息？](https://www.yuque.com/hollis666/fsn3og/awrtlggd35yanugp)
...
![](https://cdn.nlark.com/yuque/0/2023/jpeg/5378072/1676883263316-1e97eaa2-df90-44f6-8cc9-3037a438d0a0.jpeg?x-oss-process=image%2Fwatermark%2Ctype_d3F5LW1pY3JvaGVp%2Csize_33%2Ctext_SmF2YSA4IEd1IDAy%2Ccolor_FFFFFF%2Cshadow_50%2Ct_80%2Cg_se%2Cx_10%2Cy_10)

拆解下来的话，主要有以下4个步骤：

1. 发送半消息：应用程序向RocketMQ Broker发送一条半消息，该消息在Broker端的事务消息日志中被标记为“prepared”状态。

1. 执行本地事务：RocketMQ会通知应用程序执行本地事务。如果本地事务执行成功，应用程序通知RocketMQ Broker提交该事务消息。

1. 提交事务消息：RocketMQ收到提交消息以后，会将该消息的状态从“prepared”改为“committed”，并使该消息可以被消费者消费。

1. 回滚事务消息：如果本地事务执行失败，应用程序通知RocketMQ Broker回滚该事务消息，RocketMQ将该消息的状态从“prepared”改为“rollback”，并将该消息从事务消息日志中删除，从而保证该消息不会被消费者消费。
...
> 📎 相关：[✅如何基于MQ实现分布式事务](https://www.yuque.com/hollis666/fsn3og/yuku2qztfb8ki6wg)
