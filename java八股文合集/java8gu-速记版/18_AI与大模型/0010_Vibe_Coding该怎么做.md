...
> 题号：0010 ｜ 分类：18_AI与大模型

---

## 速记

- 今年的校招，很多公司都引入了vibe coding的环节，主要形式就是给你一个AI IDE，然后给你一个题目，让你在规定时间内，使用这个IDE完整对应的题目。
...
- **系统性调试能力**
- 当 AI 生成的代码运行结果不符合预期时，你是会盲目地向 AI 求助，还是能形成自己的假设，进行系统性、有逻辑的调试？
