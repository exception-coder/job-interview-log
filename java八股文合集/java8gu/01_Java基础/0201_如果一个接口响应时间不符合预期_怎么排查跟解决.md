...
> 📎 相关：[✅一次RPC请求，客户端显示超时，但是服务端不超时，可能是什么原因？](https://www.yuque.com/hollis666/fsn3og/gl5n4ovgyauybtnz)
...
> 📎 相关：[✅Arthas统计方法耗时的原理是什么？](https://www.yuque.com/hollis666/fsn3og/lswk78)
...
| 网络慢 | 同机房策略、单元化架构 |
| GC频繁 | JVM调优、调整堆大小 |
| 慢SQL | > 📎 相关：[✅如何进行SQL调优？](https://www.yuque.com/hollis666/fsn3og/mgpczmz7la99dkft) |
| 表中数据量大 | 分库分表、 分布式数据库 |
| 查询慢 | 加缓存 |
| 缓存失效 | 优化过期时间和淘汰策略 |
| 外部服务慢 | 异步调用 |
