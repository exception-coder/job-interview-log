...
- TINYBLOB / TINYTEXT: 存储最大长度为 255 字节- BLOB / TEXT: 存储最大长度为 65,535 字节（64 KB）- MEDIUMBLOB / MEDIUMTEXT: 存储最大长度为 16,777,215 字节（16 MB）- LONGBLOB / LONGTEXT: 存储最大长度为 4,294,967,295 字节（4 GB）​
