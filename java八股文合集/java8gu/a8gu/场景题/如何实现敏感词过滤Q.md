...
- 根节点不包含字符，它的子节点为a。- a节点的子节点为d、k。d节点的子节点为c和m，k节点的子节点为4- 如此构建下去的前缀树如下：- ​
​
...
- 初始状态0，对于输入c转到状态1，对于输入b转到状态4。- 状态1，对于输入a转到状态2。- 状态2，对于输入t转到状态3，状态3是接受状态，意味着找到了敏感词cat。- 同理，状态4对于输入a转到状态5，状态5对于输入t转到状态6，状态6是接受状态，意味着找到了敏感词bat。​
